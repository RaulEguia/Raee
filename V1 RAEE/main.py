...
# Scanning Function
def Scanning(frame_count=0):
    global img_plastic, img_paper, img_electronic
    global img_plastictxt, img_papertxt, img_electronicxt
    global lblimg, lblimgtxt, lblVideo, cap
    ...
    try:
        ...
        if cap is not None:
            ...
            # Reiniciar el VideoCapture cada 10000 frames
            frame_count += 1
            if frame_count % 10000 == 0:
                cap.release()
                cap = cv2.VideoCapture(0, cv2.CAP_DSHOW)

            lblVideo.after(30, lambda: Scanning(frame_count))  # Reduce la frecuencia de actualización
...
def ventana_principal():
    global cap, lblVideo, lblimg, lblimgtxt, model, clsName, img_plastic, img_paper, img_electronic
    ...
    try:
        ...
        # Clases: 0 -> Plásticos | 1 -> Papel | 2 -> Electrónico
        # Model
        model = YOLO('best.pt')
